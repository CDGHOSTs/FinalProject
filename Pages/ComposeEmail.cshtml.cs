...
namespace FinalProject.Pages
{
    ...
    {
        private readonly string connectionString = "Server=tcp:bankfinalproject.database.windows.net,1433;Initial Catalog=finalproject;Persist Security Info=False;User ID=bank;password=123456#B;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"; // Replace with your connection string
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                ...
                if (!userExists)
                {
					return RedirectToPage("/sendfail");
				}
